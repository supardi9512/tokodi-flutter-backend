...
class ProductGalleryController extends Controller
{
    ...
    public function store(ProductGalleryRequest $request, Product $product)
    {
        ...
        return redirect()->route('dashboard.product.gallery.index', $product->id)->with('success', 'Product image has been created.');
    }
    ...
    public function destroy(ProductGallery $gallery)
    {
        ...
        return redirect()->route('dashboard.product.gallery.index', $gallery->product_id)->with('success', 'Product image has been deleted.');
    }
}
